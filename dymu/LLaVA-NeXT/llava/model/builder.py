...
from llava.model.multimodal_encoder.tome_encoder import TomeVisionTower

def load_pretrained_model(model_path, model_base, model_name, tome_kwargs=None, load_8bit=False, load_4bit=False, device_map="auto", torch_dtype="float16",attn_implementation="flash_attention_2", customized_config=None, overwrite_config=None, **kwargs):
    ...
    if "llava" in model_name.lower() or is_multimodal:
        ...
        if (not isinstance(vision_tower, TomeVisionTower)) and device_map != 'auto':
