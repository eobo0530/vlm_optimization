...
```
3. Submit the results to the [evaluation server](https://opencompass.org.cn/leaderboard-multimodal): `./playground/data/eval/mmbench/answers_upload/mmbench_dev_20230712`. [EDIT Feb 18] this one is the direct submission portal: https://mmbench.opencompass.org.cn/mmbench-submission
...
[EDIT Feb 18] this one is the direct submission portal: https://mmbench.opencompass.org.cn/mmbench-submission
